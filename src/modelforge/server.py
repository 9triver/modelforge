...
from .api import calibrations, dataset_preview, download, evaluations, git_routes, lfs_routes, preview, repos, transfers, workspaces
...
def create_app() -> FastAPI:
    ...
    app.include_router(dataset_preview.router)
